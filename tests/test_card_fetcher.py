...
from deckdex.config import OpenAIConfig, ScryfallConfig
...
class TestCardFetcher(unittest.TestCase):
    ...
    def test_get_card_info_with_openai(self, mock_call_openai):
        ...
        with patch.object(
            CardFetcher,
            "search_card",
            return_value={"name": "Test Card", "type_line": "Creature", "oracle_text": "Test text"},
        ):
            ...
            self.assertEqual(
                result,
                (
                    {"name": "Test Card", "type_line": "Creature", "oracle_text": "Test text"},
    ...
    def test_get_card_info_invalid_tier(self, mock_call_openai):
        ...
        with patch.object(
            ...
            self.assertEqual(
                result,
                ({"name": "Test Card", "type_line": "Creature", "oracle_text": "Test text"}, "Test strategy", None),
            )
    ...
    def test_get_card_info_missing_strategy(self, mock_call_openai):
        ...
        with patch.object(
            ...
            self.assertEqual(
                result, ({"name": "Test Card", "type_line": "Creature", "oracle_text": "Test text"}, None, "A")
            )
