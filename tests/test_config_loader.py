...
class TestConfigLoader(unittest.TestCase):
    ...
    def test_deep_merge_nested(self):
        ...
        base = {"processing": {"batch_size": 20, "max_workers": 4}, "api": {"scryfall": {"max_retries": 3}}}
        overlay = {
            "processing": {
...
class TestEnvOverrides(unittest.TestCase):
    ...
    def test_apply_env_overrides_float(self):
        ...
        config = {"processing": {"api_delay": 0.1}}
    ...
    def test_apply_env_overrides_bool_true(self):
        ...
        config = {"api": {"openai": {"enabled": False}}}
    ...
    def test_apply_env_overrides_bool_false(self):
        ...
        config = {"api": {"openai": {"enabled": True}}}
    ...
    def test_apply_env_overrides_string(self):
        ...
        config = {"api": {"google_sheets": {"sheet_name": "magic"}}}
...
class TestBuildProcessorConfig(unittest.TestCase):
    ...
    def test_build_processor_config_defaults(self):
        ...
        yaml_config = {
            ...
            "api": {
                "scryfall": {"max_retries": 3, "retry_delay": 0.5, "timeout": 10.0},
                "google_sheets": {
                    "batch_size": 500,
                    "max_retries": 5,
                    "retry_delay": 2.0,
    ...
    def test_build_processor_config_with_cli_overrides(self):
        ...
        cli_overrides = {"processing": {"batch_size": 50, "max_workers": 8}}
...
class TestPriorityOrder(unittest.TestCase):
    ...
    def test_priority_cli_over_all(self):
        ...
        cli_overrides = {"processing": {"batch_size": 40}}
