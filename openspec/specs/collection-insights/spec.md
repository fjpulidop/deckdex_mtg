...
Server-side insight engine with 17 predefined questions across 5 categories (summary, distribution, ranking, patterns, activity), contextual suggestion logic, and rich response types (value, distribution, list, comparison, timeline).
