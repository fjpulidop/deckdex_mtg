...
MTG-themed animated canvas backgrounds using WUBRG mana colors. AetherParticles (floating dots) for app pages, CardMatrix (falling mana symbols) for landing page. Canvas-based, 30 FPS, theme-aware, reduced-motion accessible.
