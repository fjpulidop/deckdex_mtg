...
App-level visibility and state for background jobs. The active jobs bar is rendered once and shown on all main views (Dashboard, Settings). Restore of running jobs from the API happens once on app load.
