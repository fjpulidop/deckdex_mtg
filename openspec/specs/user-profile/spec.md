...
## Purpose
Allows authenticated users to personalize their identity in the app — customizing their display name and uploading a profile photo with interactive circular crop. Accessed as a modal from the navbar user dropdown.
