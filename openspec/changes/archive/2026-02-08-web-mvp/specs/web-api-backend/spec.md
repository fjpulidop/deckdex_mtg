...
The system SHALL expose endpoints to retrieve card collection data from Google Sheets.
...
The system SHALL calculate and return aggregate statistics about the collection.
